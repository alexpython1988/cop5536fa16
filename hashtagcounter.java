...
public class hashtagcounter {
	...
	public static void main(String[] args) {
		...
		if(args.length != 1){
			System.out.println("Please inlcude a input file as the argument.");
			return;
		}
...
//			outputFilePath = outPath + "output_file.txt";
		...
		//a output file named output_file.txt will be generated under the current directory
...
//					}
					...
					for(int i = 0; i < order; i ++){
						...
						String hashtag = FreqHashtagTable.get(tempMax[i]).substring(1);
